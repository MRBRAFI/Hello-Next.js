  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-4 mb-6 border border-gray-200">
      ...
      <div className="flex items-center gap-4">
        ...
        />
        <div>
          <h2 className="font-semibold text-lg">{singleStory.name}</h2>
          <p className="text-sm text-gray-600">{singleStory.designation}</p>
          <p className="text-sm text-blue-600">{singleStory.company}</p>
        </div>
      </div>

      {/* Button */}
      <Link
        href={`/stories/${singleStory.id}`}
