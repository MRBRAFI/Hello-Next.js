...
export default function page() {
  ...
  return (
    <div>
      <Title>Explores Stories of Developers</Title>

      <div>
        {devStories.map((stories) => (
          <li key={stories.id}>{stories.name}</li>
        ))}
      </div>
    </div>
  );
...
// Json Data Link https://chatgpt.com/s/t_693715b441d0819194f4737203fc9fbd
